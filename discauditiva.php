...
<html lang="es">
  <head>
    ...
    <title>Discriminación Auditiva</title>
    <!-- Favicon -->
    ...
    <style>
        ...
        div#campo{ display: flex; flex-wrap: wrap;} /* Flex para que se pueda usar "order" y "wrap" para que sea Responsive(que no quede en fila) */
  ...
  <audio id="FS">
    <source src="assets/sonidos/fotos-sonido.mp3" type="audio/mpeg">
  </audio>
  <?php
  ...
  <audio id="Good">
    <source src="assets/sonidos/candy-crush-bomba-color.mp3" type="audio/mpeg">
  </audio>
  <audio id="BeHappymp3">
...
// ------------------------------------------------------------------------------------------------------------------------
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="title-area wow fadeInLeft">
            <h2 class="title">Discriminación <span>Auditiva</span></h2>
            </br></br>
            <b><big id="msj">TOCA EL MEGÁFONO</big></b>
            </br>
            <i id="parlante" class="fa fa-volume-up" align="center" onclick="playOnomatopeya();playFotoSonido();Orden();CambiarMsj()"></i>
          </div>
        </div>
        <div class="col-md-12">
          <div class="pricing-table-content">
            <div id="campo" class="row">
              ...
              $a = 0.5;
              $count = 1;
              $cuadro = 'cuadro-correcto';
              $m = 'mc';
              $count_cortado = 1;
              $funcion = 'Correcto';
              $audio = 'playBienHechoInGame';
              ...
              while ($row = mysqli_fetch_array($rs)) {
                ...
                if ($count == 1 || $count == 3) {
                  ...
                  $cuadro = 'cuadro-incorrecto';
                  $m = 'mi';
                  $funcion = 'Incorrecto';
                  $audio = 'playMotivacional';
                }
                if ($count == 1 || $count ==2) { $count_cortado = 1;}else{ $count_cortado = 2;}

                echo "<div id='cuadro".$count."' class='col-md-3 col-sm-3 col-xs-6'>";
                  echo "<div id=".$cuadro." class='single-plan wow' data-wow-duration=".$a."s data-wow-delay=".$a."s onclick=".$audio."()>";
                    echo "<a href=#subscribe><img id='".$m."".$count_cortado."' src=".$row['Img_url']." style=width:100%; onclick=".$funcion."".$count_cortado."();OnomFin();javascript:sndReq('".$count."','".$act."')></a>";
                  echo "</div>";
                echo  "</div>";
  ...
  <section id="subscribe">
    <form method="post" action="discsemantica.php">
      <?php
  ...
  <!-- Cambio Img js -->
  <script type="text/javascript" src="assets\js\disc-auditiva.js"></script>
  <!-- Insert DB js -->
