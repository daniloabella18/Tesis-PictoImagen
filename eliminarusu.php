...
<body>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="title-area wow fadeInUp">
              ...
              <br>
              <p id="nota">NOTA: Eliminar un usuario también concidera borrar todo su historial.</p>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="title-area">
            <h2 class="title">Eliminar <span>usuario</span></h2>
          </div>
        </div>
        <div class="col-md-12">
          <div class="contact-area">
            <form id="submit_form" class="contact-form">
              ...
              <div class="send-area">
                <button type="submit" id="submit" class="send-btn">Eliminar</button>
              </div>
  ...
  <!-- End contact -->
    ...
    <!-- Insert -->
    <script src="assets\js\usu\delete.js"></script>
