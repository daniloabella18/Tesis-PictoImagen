        ...
        <div class="row">
          <div class="col-md-12">
            <div class="title-area wow fadeInUp">
              <h2 class="title">Picto<span>Imagen</span></h2>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="title-area">
            <h2 class="title">Acceder al <span>Sistema</span></h2>
          </div>
        </div>
        <div class="col-md-12">
          <div class="contact-area">
            <form action="checklogin.php" class="contact-form" method="post">
              ...
              <div class="send-area">
                <button type="submit" class="send-btn">Ingresar</button>
              </div>
            </form>
          </div>
        </div>
