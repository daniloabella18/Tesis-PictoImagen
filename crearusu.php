...
<body>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="title-area">
            <h2 class="title">Crear <span>usuario</span></h2>
          </div>
        </div>
        <div class="col-md-12">
          <div class="contact-area">
            <form id="submit_form" class="contact-form">
              <div class="form-group">
                <input type="text" class="form-control" name="usuario" id="usuario" placeholder="Nombre" required>
              </div>
              <div class="form-group">
              ...
              <div class="send-area">
                <button type="submit" name="submit" id="submit" class="send-btn">Crear</button>
              </div>
  ...
  <!-- End contact -->
    ...
    <!-- Insert -->
    <script src="assets\js\usu\insert.js"></script>
