        ...
        <div class="row">
          <div class="col-md-12">
            <div class="title-area wow fadeInUp">
              <h2 class="title">Gestión de <span>Usuarios</span></h2>
              <p>Elimine, actualice o modifique los usuarios registrados en el sistema.</p>
            </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="download-app-content">
              ...
              <a class="single-download wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay="0.5s" href="crearusu.php">
              ...
              <!-- Start single download -->
              <a class="single-download wow fadeInLeft" data-wow-duration="0.75s" data-wow-delay="0.75s" href="eliminarusu.php">
                <div class="download-icon">
              ...
              <!-- Start single download -->
              <a class="single-download wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s" href="actualizarusu.php">
                <div class="download-icon">
	...
	<div id="wrap">
		<table id=customers cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered">
          ...
          <th>Tipo ↑↓</th>
			...
			<tbody>
        <?php
          $q = "SELECT Usu_id, Usu_contra, Tus_nom FROM usuario, tipousuario WHERE Usu_Tus_cod = Tus_cod";
          $rs = mysqli_query($conn,$q);
          while ($row = mysqli_fetch_array($rs)) {
            echo "<tr>";
              echo "<td>".$row['Usu_id']."</td>";
              echo "<td>".$row['Usu_contra']."</td>";
              echo "<td>".$row['Tus_nom']."</td>";
            echo "</tr>";
          }
          ?>
			</tbody>
