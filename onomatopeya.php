...
<html lang="es">
  <head>
    ...
    <style>
      ...
      img#onom1, img#onom2, img#onom3, img#onom4 { cursor: pointer;}
  ...
  <audio autoplay>
    <source src="assets/sonidos/toca-fotos.mp3" type="audio/mpeg">
  </audio>
  <?php
...
// ------------------------------------------------------------------------------------------------------------------------
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="title-area wow fadeInLeft">
            <h2 class="title">Ono<span>matopeya</span></h2>
            </br></br>
            <b><big>TOCA LAS FOTOS</big></b>
            </br></br>
          </div>
        </div>
          ...
          echo "<div class=pricing-table-content>";
            ...
            while ($row = mysqli_fetch_array($rs)) {
              echo "<div class='col-md-3 col-sm-3 col-xs-6'>";
                echo "<div class='single-plan wow' data-wow-duration=".$a."s data-wow-delay=".$a."s onclick=playOnomatopeya()>";
                  echo "<a href=#subscribe><img id=onom".$count." src=assets\images\Actividad\Onomatopeya.png style=width:100%; onclick=CambioImagen".$count."('".$row['Img_url']."','".$row['Cua_cod']."','".$act."','".$_SESSION["usuario"]."');OnomFin();javascript:sndReq('".$count."','".$act."')></a>";
                echo "</div>";
              echo "</div>";
  ...
  <section id="subscribe">
    <form method="post" action="discauditiva.php">
      <?php
  ...
  <!-- Cambio Img js -->
  <script type="text/javascript" src="assets\js\cambioimg.js"></script>
  <!-- Insert DB js -->
